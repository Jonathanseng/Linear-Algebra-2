...
def main():
  ...
  # Define a vector in the first basis.
  vector_in_first_basis = np.array([1, 0])

  # Transform the vector to the second basis.
  vector_in_second_basis = np.dot(change_of_basis_matrix, vector_in_first_basis)

  # Print the vector in the second basis.
  print(vector_in_second_basis)
